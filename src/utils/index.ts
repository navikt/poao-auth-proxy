...
export const csvStrToStrArray = (str: string | undefined): string[] | undefined => {
	if (!str) {
		return undefined;
	}
 ...
 */
export const strToEnum = <T extends { [key: string]: string }>(str: string | undefined, enumType: T): undefined | T[keyof T] => {
